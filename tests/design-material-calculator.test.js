...
const html = fs.readFileSync('werkbank-design-preview.html', 'utf8');
...
storageData={'werkbank.design.v1.exactPrices':{'s235|IPE|160':{basis:'kg',price:5}},'werkbank.design.v1.familyPrices':{'s235|staf':{basis:'kg',price:4}}};
