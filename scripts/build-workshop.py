...
p=p.replace('werkbank.v2.','werkbank.design.v1.').replace('Werkbank — leverancierscatalogus 1','Ontwerp-preview · Workshop 01')
p=p.replace('</style>',Path('design/workshop.css').read_text()+'\n</style>',1)
p=p.replace('<section id="home" class="page">','''<section id="home"><div id="design-dashboard"><h1 class="dashboard-title">Calculaties</h1><button class="act home-primary" id="design-new">＋ Nieuwe calculatie</button><div class="section-heading"><h2>Recent</h2><a href="#kostprijs">Opgeslagen projecten ›</a></div><div id="recent-design"></div><div class="home-tools"><div class="section-heading"><h2>Gereedschap</h2><a href="#tools">Alle tools ›</a></div><div class="quick-grid" id="quick-design"></div></div></div><div id="tool-directory">''')
